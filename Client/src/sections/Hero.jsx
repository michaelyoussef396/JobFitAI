      ...
      <Element name='hero'>
        <div className="container">
            <div className="relative z-2 max-w-512 max-lg:max-w-388">
                <div className='caption small-2 uppercase text-p3'>Ai Job Helper</div>
                ...
                <p className='max-w-440 mb-14 body-1 max-md:mb-10'>We designed JobFitAi to be an easy to use, quick to learn and surprisingly powerful</p>
