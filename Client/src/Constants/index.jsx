  ...
  export const socials = [
    {
      id: "0",
      title: "X",
      icon: images.xIcon, // Use the imported icon from the images object
      url: "#",
    },
    {
      id: "1",
      title: "Threads",
      icon: images.threadsIcon, // Use the imported icon from the images object
      url: "#",
    },
    {
      id: "2",
      title: "Instagram",
      icon: images.instagramIcon, // Use the imported icon from the images object
      url: "#",
    },
    {
      id: "3",
      title: "Discord",
      icon: images.discordIcon, // Use the imported icon from the images object
      url: "#",
    },
  ];